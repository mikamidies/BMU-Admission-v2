...
const programs = ref([
  ...
  },
  {
    ...
    description:
      "На программе вы научитесь использовать финансовую информацию для принятия управленческих решений, а также освоите знания в следующих областях:<br>• финансовый и управленческий учёт<br>• анализ и интерпретация финансовой отчётности<br>• корпоративные финансы<br>• инвестиционные решения<br>• управление финансовыми рисками<br>• современные стандарты и практики в сфере Accounting & Finance<br><br>Критерии: диплом бакалавра, сертификат IELTS 6.5, интвервью<br>",
    isOpen: false,
  },
  {
    img: "/img/dir-3.webp",
